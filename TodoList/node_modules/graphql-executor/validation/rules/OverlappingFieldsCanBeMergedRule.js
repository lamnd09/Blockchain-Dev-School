...
function findConflict(
  ...
  const areMutuallyExclusive =
    ...
    (parentType1 !== parentType2 &&
      (0, _graphql.isObjectType)(parentType1) &&
      (0, _graphql.isObjectType)(parentType2));
  ...
  if (selectionSet1 && selectionSet2) {
    const conflicts = findConflictsBetweenSubSelectionSets(
      ...
      comparedFragmentPairs,
      areMutuallyExclusive,
      (0, _graphql.getNamedType)(type1),
      selectionSet1,
      (0, _graphql.getNamedType)(type2),
      selectionSet2,
    );
...
function sameValue(value1, value2) {
  return (0, _graphql.print)(value1) === (0, _graphql.print)(value2);
} // Two types conflict if both types could not apply to a value simultaneously.
// Composite types are ignored as their individual field types will be compared
// later recursively. However List and Non-Null types must match.

function doTypesConflict(type1, type2) {
  if ((0, _graphql.isListType)(type1)) {
    return (0, _graphql.isListType)(type2)
  ...
  if ((0, _graphql.isNonNullType)(type1)) {
    return (0, _graphql.isNonNullType)(type2)
      ? doTypesConflict(type1.ofType, type2.ofType)
      : true;
  }
  ...
  if ((0, _graphql.isLeafType)(type1) || (0, _graphql.isLeafType)(type2)) {
    return type1 !== type2;
  }
...
function getReferencedFieldsAndFragmentNames(
  ...
  const fragmentType = (0, _graphql.typeFromAST)(
    context.getSchema(),
  ...
  for (const selection of selectionSet.selections) {
    switch (selection.kind) {
      case _graphql.Kind.FIELD: {
        ...
        if (
          (0, _graphql.isObjectType)(parentType) ||
          (0, _graphql.isInterfaceType)(parentType)
        ) {
      ...
      case _graphql.Kind.INLINE_FRAGMENT: {
        ...
        const inlineFragmentType = typeCondition
          ? (0, _graphql.typeFromAST)(context.getSchema(), typeCondition)
          : parentType;
