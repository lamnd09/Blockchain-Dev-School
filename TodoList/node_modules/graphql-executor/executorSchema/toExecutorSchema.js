...
exports.toExecutorSchema = void 0;
  ...
  function getRootType(operation) {
    ...
    false ||
      (0, _invariant.invariant)(
        false,
        'Unexpected operation type: ' + (0, _inspect.inspect)(operation),
      );
  }
...
const toExecutorSchema = (0, _memoize.memoize1)(_toExecutorSchema);
exports.toExecutorSchema = toExecutorSchema;
