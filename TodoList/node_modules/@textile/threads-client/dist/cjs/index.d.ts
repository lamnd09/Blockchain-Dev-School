...
import { ComparisonJSON, CriterionJSON, Event, Filter, Patch, PatchType, Query, QueryJSON, ReadTransaction, SortJSON, ValueJSON, Where, WriteTransaction } from './models';
export { Filter, Query, Where, WriteTransaction, ReadTransaction, QueryJSON, ValueJSON, ComparisonJSON, CriterionJSON, SortJSON, JSONSchema3or4, Event, Patch, PatchType, };
export declare function getFunctionBody(fn: ((...args: any[]) => any) | string): string;
/**
